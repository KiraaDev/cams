...
import { deleteBeneficiary } from "../beneficiary/actions";
...
type DeleteBeneficiaryModalProps = {
...
export default function DeleteBeneficiaryModal({
  ...
  const handleDelete = () => {
    setErrorMessage(null); // Reset errors before trying
    
    startTransition(async () => {
      // Direct call to your imported server action
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4 backdrop-blur-sm">
      <div className="w-full max-w-md overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl animate-in fade-in zoom-in-95 duration-150">
        ...
        {errorMessage && (
          <div className="mx-6 mt-4 rounded-md bg-red-50 p-3 border border-red-200">
